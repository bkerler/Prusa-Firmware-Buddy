...
#define HEATER_XL_HOTEND_MINTEMP 5
#define HEATER_0_MINTEMP HEATER_XL_HOTEND_MINTEMP
...
#define Z_CLEARANCE_BETWEEN_PROBES 0.21f // Z Clearance between probe points 1
